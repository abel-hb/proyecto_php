...
<div class="banner">
	<nav class="navbar navbar-default">
		<div class="navbar-header navbar-left">
			...
			<h1><a class="navbar-brand" href="index.php"><span><img src="images/logo.PNG" width="60" height="60"></span>TRANS AL-ANDALUS</a></h1>
		</div>
...
<!--web icons -->
	...
	<div class="typo">
		<div class="container">
							...
							<div class="loginBox text-center">
								...
								<form action="calcular-espacio.php" method="post">                           	
									...
									<div class="form-group"> 
											...
											<input type="hidden" class="form-control input-lg" name="producto" placeholder="Producto a Empaquetar"  maxLengt="10"required>       
									</div>
									<div class="form-group"> 
			...
			<h2 class="typoh2">Opcion 1</h2>
			<p>Aquí te mostraremos los resultados del calcular el espacio en el almacen seleccionado.</p>
